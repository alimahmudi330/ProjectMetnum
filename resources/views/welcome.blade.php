...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Asri Pigura / Dashboard</title>
    ...
    <style>
        .main-text h1 {
            ...
            line-height: 1.2; 
            font-weight: bold;
            color: #333; /* Kamu bisa ganti warna sesuai kebutuhan */
        }
    </style>
    </head>
        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="flex items-center justify-between py-10 px-6">
                    <span class="text-2xl font-semibold text-gray-900" style="font-family: Arial, sans-serif;">Asri Pigura</span>
                        <div class="flex-1"></div> <!-- Placeholder untuk menjaga tata letak -->
                        <nav class="flex justify-center items-center flex-1 gap-4">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-12 lg:grid-cols-1 lg:gap-16">
                            <a
                                ...
                                <div id="screenshot-container" class="relative flex w-full items-center">
                                    <div class="main-text">
                                        <h1>ASRI PIGURA</h1>
                                    ...
                                    <img
                                        src="assets/images/pigura.jpg"
                                        style="width: 60%; height: auto; object-fit: cover; margin-left: auto;"/>
                                </div>
                            </a>
                        </div>
